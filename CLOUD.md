# VM Environment Setup - FloodGuard Surabaya

## Overview
This repository contains FloodGuard Surabaya, an isometric flood-management simulation game built with Next.js, React 19, TypeScript, and TailwindCSS. The project uses Radix UI components for the interface and includes sprite-based rendering for buildings, vehicles, and other game elements.
...
The VM environment is fully configured and ready to run FloodGuard Surabaya. All core functionality (build, dev server) works correctly. The project can be developed, built, and deployed without any additional setup.
